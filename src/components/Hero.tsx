  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className={`absolute top-1/2 left-3/4 w-1.5 h-1.5 ${
          isDark ? 'bg-cyan-300' : 'bg-blue-400'
        } rounded-full animate-pulse animation-delay-2000`}></div>
      </div>
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <h2 className="mb-6 min-h-[3rem] flex items-center justify-center">
          ...
          <div className="flex flex-wrap justify-center gap-6 mb-12">
            ...
            <a
              href="www.linkedin.com/in/kanikepavankumar-pk967624"
              target="_blank"
              rel="noopener noreferrer"
              className={`flex items-center gap-2 px-6 py-3 ${
                isDark 
            ...
            <a
              href="kanikepavankumar06@gmail.com"
              className={`flex items-center gap-2 px-6 py-3 ${
                isDark 
                  ? 'bg-gray-800/50 border-gray-700 hover:border-cyan-400 hover:shadow-cyan-400/25' 
                  : 'bg-white/50 border-gray-300 hover:border-blue-500 hover:shadow-blue-500/25'
